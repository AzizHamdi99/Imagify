...
function Hero() {
  return (
    <div className='flex items-center justify-center flex-col'>
     ...
     <p className='mt-2 text-[#545454] text-[18px] font-[400] text-center'>Unleash your creativity with AI. Turn your imagination into visual art in seconds – just type, and watch the magic happen.</p>
      <div>
        <p>Generate Images</p>
