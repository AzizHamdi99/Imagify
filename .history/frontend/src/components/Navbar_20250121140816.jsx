...
const{showLogin,setShowLogin,showLoginForm,setShowLogin}=useContext(AppContext)
const changes=()=>{
...
{showLogin? <div className='flex gap-8 items-center font-[400] text-[15px] '>
  ...
  <p onClick={changes} className='rounded-[50px] bg-black px-12 py-2 text-white  text-center items-center'>Login</p>
