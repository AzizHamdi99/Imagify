...
function Steps() {
  ...
  return (
    <motion.div  initial={{opacity:0.2,}} animate={{opacity:1}} transition={{delay:1.2, duration:0.8}} className='text-[#545454] text-[15px] pt-4'>Generated images from imagifyclassName='flex flex-col items-center justify-center  pt-28 '>
