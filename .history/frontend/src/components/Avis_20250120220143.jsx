    ...
    <div className='flex flex-col items-center justify-center mt-32'>
      ...
      <div className='flex gap-10 text-center items-center justify-center  '>
        {testimonialsData.map((item)=>{
          return(
            <div className=' flex flex-col justify-center items-center border-[1px] border-[#E1E1E1] p-10'>
              <img className='h-[42px] w-[42px] mb-2' src={item.image} alt="" />
              <p className='text-[18px] text-[#4B445A] font-[500]'>{item.name}</p>
              <p className='text-[13px] text-[#62577B] font-[500] mb-4'>{item.role}</p>
              <div className='flex '>
              ...
              <p className='w-[322px] text-[16px] text-[#797484] font-[400]'>{item.text}</p>
            </div>
          )
        })}
      </div>
