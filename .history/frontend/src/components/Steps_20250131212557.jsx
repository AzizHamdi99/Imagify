...
function Steps() {
  ...
  return (
    <motion.div  initial={{opacity:0.2,y:100}} viewport={{once:true}} whileInView={{opacity}} transition={{ duration:0.8}} className='text-[#545454] text-[15px] pt-4'>Generated images from imagifyclassName='flex flex-col items-center justify-center  pt-28 '>
