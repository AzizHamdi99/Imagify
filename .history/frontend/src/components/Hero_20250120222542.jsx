...
function Hero() {
  return (
    <div className='flex items-center justify-center flex-col pt-28 bg-[#f4fff9]'>
      <div className='flex gap-2 bg-white border-[0.3px] border-[#7A7A7A] text-[#696969] px-9 py-2 rounded-[50px] items-center text-[15px] font-[400]'>
     ...
     <p className='mt-2 text-[#545454] text-[18px] font-[400] text-center w-[570px]'>Unleash your creativity with AI. Turn your imagination into visual art in seconds – just type, and watch the magic happen.</p>
      <div className=' my-10 flex items-center gap-2 px-10 py-3  bg-black text-white rounded-[50px] cursor-pointer'>
        <p>Generate Images</p>
      ...
      <p className='text-[#545454] text-[15px] mt-4'>Generated images from imagify</p>
