  ...
  return (
    <form action="" className='flex items-center justify-center flex-col bg-[#f2fff8] h-screen'>
      ...
      <div className='mt-12 flex items-center justify-between gap-4 '>
          <button className='border-[1px] cursor-pointer border-black py-2 px-9 rounded-[50px] font-[500]'>Generate Another</button>
          <a download className='border-[1px] border-black cursor-pointer bg-black py-2 px-8 rounded-[50px] font-[500] text-white'>Download</a>
      </div>
      }
