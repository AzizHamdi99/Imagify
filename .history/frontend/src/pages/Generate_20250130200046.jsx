...
console.log(prompt)
  ...
  return (
    <form action="" onSubmit={generate}  className='flex items-center justify-center flex-col bg-[#f2fff8] h-screen'>
      ...
      <div className='mt-12 bg-[#6B6B6B] rounded-[50px] w-[651px] h-[56px] flex items-center justify-between '>
        ...
        <button onClick={generate} className='text-white rounded-[50px] text-[15px] font-[400] bg-[#1B1B1B] border-[1px] border-[#000000] w-[195px] h-[50px] mr-[3px]'>Generate</button>
      </div>
      }
      {download&&
