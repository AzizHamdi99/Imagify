...
const{user,setUser}=useContext(AppContext)
  ...
  return (
    <div className='flex items-center justify-center flex-col  bg-[#f2fff8] h-[100vh]'>
        ...
        {plans.map((item)=>{
          return(
            <div className='bg-white border-[1px] border-[#EDEDED] p-8 px-12 rounded-[10px] shadow-lg text-[#515151]'>
              ...
              <p className=' cursor-pointer bg-[#262626] rounded-[6px] text-white text-center py-2 px-16 text-[15px] mt-10'>{user? 'Purshase'}Get started</p>
            </div>
          )
        })}
